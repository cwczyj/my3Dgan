function [output,dlamda,dbeta]= my3DBatchNormalization(A, lamda, beta, forward_or_backward,Loss)
    ...
    elseif strcmp(forward_or_backward,'backward')
        ...
        output=di1+di2+1/size(A,4)*repmat(d_mu,1,1,1,size(A,4));
    end
